...
OUTPUT_FILE_HEP_CATEGORIES.write('**⚠️⚠️⚠️ Warning! LaTeX formatting in GitHub (used in the descriptions) is not functioning properly. Please refer to the [PDF version found here](/BY_HEP/BYHEP_DETAIL.pdf)</a> ⚠️⚠️⚠️**\n\n')
OUTPUT_FILE_HEP_CATEGORIES.write("[![HEPCAT_TO_HEP](https://img.shields.io/badge/Link_to-HEP-5BC0EB)](/BY_HEP#readme) ⟵ Click the following for the living review organized by HEP topics  \n")
OUTPUT_FILE_HEP_CATEGORIES.write("[![HEPCAT_TO_QIS](https://img.shields.io/badge/Link_to-QIS-9BC53D)](/BY_QIS#readme) ⟵ Click the following for the living review organized by QIS topics  \n")
...
OUTPUT_FILE_HEP_CATEGORIES.write('**⚠️⚠️⚠️ Warning! LaTeX formatting in GitHub (used in the descriptions) is not functioning properly. Please refer to the [PDF version found here](/BY_QIS/BYQIS_DETAIL.pdf)</a> ⚠️⚠️⚠️**\n\n')
OUTPUT_FILE_QIS_CATEGORIES.write("[![QISCAT_TO_HEP](https://img.shields.io/badge/Link_to-HEP-5BC0EB)](/BY_HEP#readme) ⟵ Click the following for the living review organized by HEP topics  \n")
OUTPUT_FILE_QIS_CATEGORIES.write("[![QISCAT_TO_QIS](https://img.shields.io/badge/Link_to-QIS-9BC53D)](/BY_QIS#readme) ⟵ Click the following for the living review organized by QIS topics  \n")
...
list_subcategories_to_md(OUTPUT_FILE_MAIN, OUTPUT_FILE_QIS_CATEGORIES, categories_qis, df_csv_qis, "HEP")
...
OUTPUT_FILE_HEP.write('**⚠️⚠️⚠️ Warning! LaTeX formatting in GitHub (used in the descriptions of each paper) is not functioning properly. Please refer to the [PDF version found here](/BY_HEP/BYHEP_DETAIL.pdf)</a> ⚠️⚠️⚠️**\n\n')
...
OUTPUT_FILE_HEP.write("[![HEP_LIST](https://img.shields.io/badge/Download_PDF-List-ffcce7)](/BY_HEP/BYHEP_LIST.pdf) ⟵ PDF of list of references  \n")
OUTPUT_FILE_HEP.write("[![HEP_BRIEF](https://img.shields.io/badge/Download_PDF-List-daf2dc)](/BY_HEP/BYHEP_BRIEF.pdf) ⟵ PDF of references with short descriptions (HEP context, methods, results and conclusions)  \n")
OUTPUT_FILE_HEP.write("[![HEP_DETAIL](https://img.shields.io/badge/Download_PDF-Detail-81b7df)](/BY_HEP/BYHEP_DETAIL.pdf) ⟵ PDF of references with detailed descriptions  \n")
...
OUTPUT_FILE_QIS.write('**⚠️⚠️⚠️ Warning! LaTeX formatting in GitHub (used in the descriptions of each paper) is not functioning properly. Please refer to the [PDF version found here](/BY_QIS/BYQIS_DETAIL.pdf)</a> ⚠️⚠️⚠️**\n\n')
...
OUTPUT_FILE_QIS.write("[![QIS_LIST](https://img.shields.io/badge/Download_PDF-List-ffcce7)](/BY_QIS/BYQIS_LIST.pdf) ⟵ PDF of list of references  \n")
OUTPUT_FILE_QIS.write("[![QIS_BRIEF](https://img.shields.io/badge/Download_PDF-List-daf2dc)](/BY_QIS/BYQIS_BRIEF.pdf) ⟵ PDF of references with short descriptions (QIS context, methods, results and conclusions)  \n")
OUTPUT_FILE_QIS.write("[![QIS_DETAIL](https://img.shields.io/badge/Download_PDF-Detail-81b7df)](/BY_QIS/BYQIS_DETAIL.pdf) ⟵ PDF of references with detailed descriptions  \n")
